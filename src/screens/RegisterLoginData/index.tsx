...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    if (!(await schema.isValid(newLoginData, { abortEarly: false }))) {
      return;
    }
    ...
    if (storagedData) {
      dataParsed = JSON.parse(storagedData);
    }
    await AsyncStorage.setItem(dataKey, JSON.stringify([...dataParsed, newLoginData]));
    navigate('Home');
  }
